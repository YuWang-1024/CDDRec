    ...
    def iteration(self, epoch, dataloader, full_sort=False, train=True):
        ...
        if train:
            ...
            for batch in rec_data_iter:
                ...
                _, input_ids, target_pos, target_neg, _, aug_input_ids = batch

                loss, batch_auc, conditional_emb = self.model(input_ids, target_pos, target_neg, aug_input_ids, epoch) # shape:b*max_Sq*d
            ...
            if full_sort:
                ...
                with torch.no_grad():
                    for batch in rec_data_iter:
                        ...
                        recommend_output = self.model.inference(input_ids)
